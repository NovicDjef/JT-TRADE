...
const reasons = [
  {
    ...
    title: "Cabinet agree",
    description:
      "Entreprise legalement enregistree et reconnue (JTTS SARL)",
  },
  {
    icon: Users,
    title: "Accompagnement personnalise",
    description: "Un suivi individuel de A a Z pour chaque client",
  },
  {
    icon: Clock,
    title: "Rapidite",
    description:
      "Traitement efficace de vos dossiers dans les meilleurs delais",
  },
  {
    icon: Award,
    title: "Expertise",
    description:
      "Des annees d'experience en immigration Canada et Europe",
  },
  {
    icon: Headphones,
    title: "Disponibilite",
  ...
  {
    icon: FileCheck,
    title: "Taux de reussite eleve",
    description:
      "La majorite de nos clients obtiennent leur visa avec succes",
  },
];
          ...
          {reasons.map((reason, index) => (
            ...
            >
              <div className="flex-shrink-0 w-12 h-12 bg-primary-50 rounded-lg flex items-center justify-center">
                <reason.icon className="text-primary-500" size={24} />
              </div>
              <div>
